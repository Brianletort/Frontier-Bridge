...
Frontier Bridge currently has no corporate sponsor. If sponsorship is ever accepted, it will not change how technical decisions are made: the results-integrity rule, the RFC process, and the open Apache 2.0 license apply equally to all contributions, sponsored or not — and no sponsor is named anywhere in this repo until confirmation exists in writing.
